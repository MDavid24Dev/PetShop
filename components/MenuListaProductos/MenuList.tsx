   ...
   // <NavigationMenu viewport={isMobile}>
      <NavigationMenuList className="flex w-full flex-wrap gap-2">
        ...
        <NavigationMenuItem className="hidden md:block">
          ...
          <NavigationMenuContent className="absolute top-full left-0 z-50">{/* el absolute top-full hace que baje justo debajo del boton, el z-50 asegura que no se esconda*/}
        ...
        <NavigationMenuItem className="hidden md:block">
          <NavigationMenuTrigger>Tendencia</NavigationMenuTrigger>
          <NavigationMenuContent className="absolute top-full left-0 z-50">
